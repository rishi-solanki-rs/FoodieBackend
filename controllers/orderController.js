...
const calculateBill = async (
  ...
  try {
    ...
    return {
      ...
      platformFeeAfterDiscount: breakdown.platformFeeAfterDiscount ?? breakdown.platformFee,
      adminDeliverySubsidy: breakdown.adminDeliverySubsidy || 0,
  ...
  try {
    ...
    const orderDoc = {
      ...
      paymentBreakdown: {
        ...
        platformFeeAfterDiscount: toMoney(canonicalSettlement.platformFeeAfterDiscount ?? bill.platformFee ?? 0),
        adminDeliverySubsidy: toMoney(canonicalSettlement.adminDeliverySubsidy || 0),
